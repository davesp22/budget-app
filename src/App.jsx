...
const CATS = [
  { id:"alimentation", label:"Alimentation", icon:"🛒", color:"#34E5A0",
    kw:["coop","migros","aldi","lidl","denner","spar","volg","pick pay","laiterie","boucherie","boulangerie","fromagerie","epicerie","manor food","supermarché","grocery","cominox","gottardo","pascal rossier","landi","avec","volg","spar"] },
